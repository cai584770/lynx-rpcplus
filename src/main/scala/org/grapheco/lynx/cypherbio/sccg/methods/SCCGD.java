...
public class SCCGD {
	...
	public static void uncompress(String referenceFilePath, String result_of_compress, String result_of_uncompress)
			throws IOException, InterruptedException {
		if (referenceFilePath.equals("") || result_of_compress.equals("") || result_of_uncompress.equals("")) {
			System.out.println("File name error!");
			System.exit(0);
		}

		String reference_file = referenceFilePath;
		String in_file_7z = result_of_compress;
		String[] chrs = in_file_7z.split("/");
		String final_file = result_of_uncompress + "/" + chrs[(chrs.length - 1)];
